...
)
{
  ...
  sk_cpu.set_detect_time_freq(!disable_ft);
  sk_cpu.set_detect_freq(!disable_tscr);
  sk_cpu.set_detect_time(!disable_fscr);
  ...
  sk_cuda.set_detect_time_freq(!disable_ft);
  sk_cuda.set_detect_freq(!disable_tscr);
  sk_cuda.set_detect_time(!disable_fscr);

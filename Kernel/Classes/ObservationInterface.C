/***************************************************************************
 *
 *   Copyright (C) 2011-2025 by Willem van Straten
...
dsp::Observation::Interface::Interface( Observation *c )
{
  ...
  add( &Observation::get_rate,
       &Observation::set_rate,
       "rate", "Sampling rate (Hz)" );

  add( &Observation::get_interval,
       &Observation::set_interval,
...
add( &Observation::get_machine,
  ...
  add( &Observation::get_dual_sideband,
       &Observation::set_dual_sideband,
       "dsb", "Dual-sidebandedness of spectrum");

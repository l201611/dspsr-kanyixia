...
namespace dsp {
  ...
  //! Bit unpacker that keeps a histogram of digitized states
  ...
  public:
    ...
    /*!
      @param idig index of the digitizer that samples a unique process
      @param expect expected number of elements in the histogram
    */

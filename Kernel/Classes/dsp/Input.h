...
namespace dsp {
  ...
  */
  ...
  public:
    ...
    virtual uint64_t get_stride () const { return get_block_size()-get_overlap(); }
    ...
    void set_resolution (unsigned res) { resolution = res; }
  ...
  protected:
    ...
    /*! In the elements of a SerialFiles array, the start_offset is negative in files later than the absolute offset. */

/***************************************************************************
 *
 *   Copyright (C) 2002-2025 by Willem van Straten and Jesmigel Cantos
...
void dsp::Operation::operate ()
{
  ...
  {
    optime.stop();
    throw error += "dsp::Operation::operate";
  }

  optime.stop();
  performance_metrics->total_processing_time = optime.get_total();
}
...
{
  if (verbose)
    cerr << "dsp::Operation::reset name=" << name << " this=" << this << endl;
...
void dsp::Operation::reset_time () const
{
  if (verbose)
    cerr << "dsp::Operation::reset_time name=" << name << " this=" << this << endl;

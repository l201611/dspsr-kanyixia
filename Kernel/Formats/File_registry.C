...
static dsp::File::Register::Enter<dsp::DADABlockFile> dada_block_file;
...
static dsp::File::Register::Enter<dsp::SerialFiles> multifile;
...
*/
const dsp::File::Register& dsp::File::get_register ()
{
